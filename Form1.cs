...
namespace proyecto_so_hilos
{
    public partial class Form1 : Form
    {
        ...
        {
            //Application.Exit();
            System.Console.WriteLine(Obj_T1.ThreadState.ToString());
            System.Console.WriteLine(Obj_T2.ThreadState.ToString());

            if (Obj_T1.ThreadState == ThreadState.WaitSleepJoin)
            {
                Obj_Utilidad.Mensaje("El Hilo de Pares está en Ejecución, No se puede Salir");
            }
            else if (Obj_T2.ThreadState == ThreadState.WaitSleepJoin)
            {
                Obj_Utilidad.Mensaje("El Hilo de ImpPares está en Ejecución, No se puede Salir");
            }
            else
            {
                this.Dispose(true);
